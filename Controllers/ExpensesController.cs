...
namespace Buckets.Controllers
{
    public class ExpensesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Amount")] Expense expense)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Name,Description,Amount")] Expense expense)
        {
            if (id != expense.Id)
            {
                return NotFound();
