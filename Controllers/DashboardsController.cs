...
namespace Buckets.Controllers
{
    public class DashboardsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,BucketsTile,BankAccountsTile,BillsTile,DashboardsTile,IncomeTile,ExpenseTile")] Dashboard dashboard)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Name,Description,BucketsTile,BankAccountsTile,BillsTile,DashboardsTile,IncomeTile,ExpenseTile")] Dashboard dashboard)
        {
            if (id != dashboard.Id)
            {
                return NotFound();
