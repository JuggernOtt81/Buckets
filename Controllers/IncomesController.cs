...
namespace Buckets.Controllers
{
    public class IncomesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Amount")] Income income)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Name,Description,Amount")] Income income)
        {
            if (id != income.Id)
            {
                return NotFound();
